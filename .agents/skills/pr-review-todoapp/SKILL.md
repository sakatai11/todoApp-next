...
**ベースワークフロー**: [github-pr-review-workflow](~/.Codex/skills/github-pr-review-workflow/SKILL.md)
...
- [プロジェクトAGENTS.md](@.Codex/AGENTS.md)
- [コード品質ルール](@.Codex/rules/code-quality.md)
- [セキュリティルール](@.Codex/rules/security.md)
- [開発フロールール](@.Codex/rules/development.md)
